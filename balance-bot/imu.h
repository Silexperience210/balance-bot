...
// de départ à partir de l'accéléromètre. Bloquant ~300 ms, appelé
// uniquement depuis Balance::begin(). false si lectures invalides.
...
// false si la lecture I2C a échoué (l'angle précédent est conservé).
